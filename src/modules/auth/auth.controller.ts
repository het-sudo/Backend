...
import type { Login, Register, TypedRequest, RefreshTokenRequest } from "./auth.interface.js";
...
export const login: RequestHandler = asyncHandler(
  async (req: TypedRequest<Login>, res: Response) => {
    ...
    // Set cookies
    res.cookie("accessToken", accessToken, { httpOnly: true, secure: process.env.NODE_ENV === "production", maxAge: 15 * 60 * 1000 }); // 15 mins
